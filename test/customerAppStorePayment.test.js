...
test("payment step styles exist and the Customer App payment build id is bumped", () => {
  ...
  assert.match(read("customer-app/index.html"), /modules\/store\.js\?v=20260827_minimum_price_upload_cache_v1/);
  assert.match(read("customer-app/sw.js"), /BUILD_ID = "20260827_minimum_price_upload_cache_v1"/);
