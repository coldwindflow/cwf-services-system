(function () {
  ...
  const serviceKinds = [
    ...
    { value: "relocate", label: "ย้ายแอร์", short: "ย้ายแอร์", job_type: "ติดตั้ง", copy: "ประเมินหน้างาน ถอด ย้าย และติดตั้งใหม่" },
    { value: "refrigerant", label: "เติมน้ำยา / ตรวจรั่ว", short: "ระบบน้ำยา", job_type: "ซ่อม", repair_variant: "เติมน้ำยา/ระบบน้ำยา", copy: "ตรวจอาการระบบน้ำยาและให้ทีมประเมินก่อนทำ" },
  ...
  const repairVariants = [
    ...
    { value: "เติมน้ำยา/ระบบน้ำยา", label: "เติมน้ำยา / ระบบน้ำยา" },
    { value: "ซ่อมเปลี่ยนอะไหล่", label: "ซ่อม / เปลี่ยนอะไหล่" },
  ];
  ...
  function normalizeServiceDraft(draft) {
    ...
    } else if (["install", "relocate", "refrigerant"].includes(service.service_kind)) {
      service.needs_admin_estimate = true;
      service.admin_reason = service.service_kind === "relocate"
        ? "งานย้ายแอร์ต้องประเมินหน้างานและระยะเวลา"
        : service.service_kind === "install"
          ? "งานติดตั้งต้องประเมินหน้างานและระยะเวลา"
          : "งานระบบน้ำยาต้องตรวจอาการและประเมินปริมาณจริง";
    } else if (!["ล้าง", "ซ่อม"].includes(service.job_type)) {
      service.needs_admin_estimate = true;
  ...
  const additionalServices = [
    {
      ...
      route: "urgent",
      title: "ย้ายแอร์",
      kicker: "ประเมินหน้างาน",
      copy: "ถอด ย้าย และติดตั้งใหม่ ทีมงานต้องประเมินระยะท่อและหน้างานก่อน",
      draft: { service_kind: "relocate", job_type: "ติดตั้ง", ac_type: UNKNOWN_AC, btu: UNKNOWN_BTU, machine_count: 1 },
      priceable: false,
    },
    {
      id: "refrigerant",
      route: "urgent",
      title: "เติมน้ำยา / ตรวจรั่ว",
      kicker: "ตรวจอาการก่อน",
      copy: "ไม่เติมน้ำยาโดยไม่ตรวจสาเหตุ ระบบจะส่งข้อมูลให้ทีมประเมินก่อนทำ",
      draft: { service_kind: "refrigerant", job_type: "ซ่อม", ac_type: UNKNOWN_AC, btu: UNKNOWN_BTU, repair_variant: "เติมน้ำยา/ระบบน้ำยา", machine_count: 1 },
      priceable: false,
    },
    {
      id: "hanging-clean",
      route: "scheduled",
      title: "ล้างแอร์แขวน / ใต้ฝ้า",
      kicker: "งานร้านค้า / สำนักงาน",
      copy: "เลือกจำนวนเครื่องและดู Slot จริงของช่างที่รับงานชนิดนี้ได้",
      draft: { service_kind: "clean", job_type: "ล้าง", ac_type: "แขวน", btu: "24000", machine_count: 1 },
      priceable: true,
    },
  ];
  ...
  function commerceItem(id) {
    return [...commerceCategories, ...quickServices, ...additionalServices, ...cleaningMethods].find((item) => item.id === id || item.title === id) || null;
  }
