...
test("payment step styles exist and the Customer App payment build id is bumped", () => {
  ...
  assert.match(read("customer-app/index.html"), /modules\/store\.js\?v=20260720_customer_booking_pr4_v2/);
  assert.match(read("customer-app/sw.js"), /BUILD_ID = "20260720_customer_booking_pr4_v2"/);
